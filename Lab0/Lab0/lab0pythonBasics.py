...
dd = int(d)
#only if logically possible: you can't convert letters to numbers, but you can
#convert numbers to characters (i.e. a string object)

#NOTE: Don't use variable names for built-in functions and statements. 
#You can tell by the color name (e.g. note the color of 'float' or 'import' above)
#Python will allow you do it but this will make your code ambiguous and could
#impact the desired outcome of your code.
...
type(a)
#this is your first build-in function
type(c)
